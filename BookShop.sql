...
GO
INSERT [dbo].[Account] ([userID], [password], [fullName], [roleID]) VALUES (N'thai123', 123456, N'user01', 0)
GO
INSERT [dbo].[Account] ([userID], [password], [fullName], [roleID]) VALUES (N'thai456', 123456, N'user01', 0) */
GO
INSERT  [dbo].[Account] ([userID], [password], [fullName], [roleID]) VALUES (N'thai456', 123456, N'user01', 0);
GO
INSERT [dbo].[Account] ([userID], [password], [fullName],[roleID]) values (N'thai123', 123456, N'NgaiTom', 0);
GO
INSERT [dbo].[Book] ([bookId], [description], [price], [bookName], [author], [yearOfProduction], [quantity], [bookImgURL], [categoryID]) VALUES (N'B001', N'Đắc nhân tâm (được lòng người), tên tiếng Anh là How to Win Friends and Influence People là một quyển sách nhằm tự giúp bản thân bán chạy nhất từ trước đến nay.', 350, N'Đắc Nhân Tâm', N'Dale Carnegie', 1980, 300, N'01.png', N'C003')
GO
...
GO
INSERT [dbo].[Payment] ([paymentId], [userID], [dateCreate], [totalPayment], [address], [phoneNumber], [status]) VALUES (1, N'a002', CAST(N'2024-30-06' AS Date), 360, N'Quynh Luu Nghe An', N'0123456789', 1)
GO
INSERT [dbo].[Payment] ([paymentId], [userID], [dateCreate], [totalPayment], [address], [phoneNumber], [status]) VALUES (2, N'a002', CAST(N'2024-30-06' AS Date), 360, N'1/123 q1 tphcm', N'0123456789', 0)
GO
INSERT [dbo].[Payment] ([paymentId], [userID], [dateCreate], [totalPayment], [address], [phoneNumber], [status]) VALUES (3, N'a002', CAST(N'2024-30-06' AS Date), 304, N'4859 Vinh Nghe An', N'0100000012', 0)
GO
INSERT [dbo].[Payment] ([paymentId], [userID], [dateCreate], [totalPayment], [address], [phoneNumber], [status]) VALUES (4, N'a002', CAST(N'2024-30-06' AS Date), 657, N'q1 tphcm', N'0123456123', 0)
GO
