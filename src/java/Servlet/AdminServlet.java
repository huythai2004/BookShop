    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            if (user != null && user.getRole() == 1){
                int pageIndex =1;
                String pageIndexParam = request.getParameter("i");
               ...
               // int endPage = bookCount/3;
               int endPage = (int) Math.ceil((double) bookCount / BOOKS_PER_PAGE);
//                if (bookCount % 3 != 0){
//                    endPage++;
//                }
                ...
                request.setAttribute("listBook", bookDao.getTop3Book(pageIndex));
                request.setAttribute("listCategory", categoryDao.getAllCategory());
                request.setAttribute("tag", categoryDao);
